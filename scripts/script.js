...
// DOM - document object
const taskContents = document.querySelector(".task__contents"); //here to show
const taskModal = document.querySelector(".task__modal__body"); // here to see the model
...
const searchTask = (e) => {
  ...
  resultData.map((cardData) => {
    taskContents.insertAdjacentHTML("before-end", htmlTaskContent(cardData));
  });
};
